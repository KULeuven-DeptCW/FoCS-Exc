...
\begin{answer}
In order to do this we need to show two things: \langdef{Double-Sat} is in \cclass{NP} and there exists a reduction from \textsc{Sat} in polynomial time to \langdef{Double-Sat}.
\end{answer}
\end{exercise}
