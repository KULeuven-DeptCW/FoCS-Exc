\begin{tikzpicture}[shorten >=1pt,node distance=2cm,auto,scale=1.5,nd/.style={draw=black,circle,scale=\sc,minimum width=0.75 cm,minimum height=1 cm},ndg/.style={nd,fill=gray},yscale=-1]
\def\sc{0.75}
\node[nd]  (R0) at (0,0)     {$T$};
\node[nd]  (R1) at (-2,1)    {};
\node[nd]  (R2) at (-2,-1)   {};
